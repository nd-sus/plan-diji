...
public class STGooglePlusListener   {
	// facebook handler
	// facebook handler
		 static Logger logger = Logger.getLogger(STGooglePlusListener.class);
		 byte[] body;
		 String routingKey;
		ExecutorService executor;
		 ...
		 Properties prop;
		 Long counterValue;
		public STGooglePlusListener( byte[] body,
			...
			public static  void processData(byte[] body,
					 String routingKey, ExecutorService executor, 
					 com.rabbitmq.client.Connection connection1,
					 Properties prop,  Long counterValue,MongoClient mongo1) {
				...
				try {
					...
					accessTokenValue = ((String) jsonObject.get("access_token") != null ? (String) jsonObject
							.get("access_token") : "");
					refreshTokenValue= ((String) jsonObject.get("refresh_token") != null ? (String) jsonObject
							.get("refresh_token") : "");
					/*refreshTokenValue="1/P7XmbWY3BE8o57a5yAvDckiwOAZkRVIah4tTXqnrxCY";
					accessTokenValue ="ya29.BAEpHzyQH3yIoNTb00AuAGbHET4bpaZOBSI_t94n06U8-zJhcmlFla3E1pPgzucS86C719w9L3c19Q";*/
					...
					//	plus = factory.getApi(accessTokenValue);
							plus = factory.getApi(accessTokenValue,refreshTokenValue,null);
					...
					try {
						...
						for (Activity i : data) {
							...
							logger.info("\n STGOOGLEPLUSstart processing " + i.getId()
